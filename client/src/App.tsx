...
import MarketStudiesPage from "@/pages/app/marketing/market-studies";
import MarketStudyDetailPage from "@/pages/app/marketing/market-study-detail";
...
import SegmentsPage from "@/pages/app/marketing/segments";
import WorkflowsPage from "@/pages/app/marketing/workflows";
...
function Router() {
  return (
    <Switch>
      ...
      <Route path="/app/marketing/market-studies/:id">{() => <PageFeatureGate featureKey="marketStudyWizard" label="Market Study Wizard" description="End-to-end market study from a brief or URL: segments, TAM/SAM, opportunity matrix, and executive summary. Upgrade to unlock this feature."><MarketStudyDetailPage /></PageFeatureGate>}</Route>
      <Route path="/app/marketing/market-studies">{() => <PageFeatureGate featureKey="marketStudyWizard" label="Market Study Wizard" description="End-to-end market study from a brief or URL: segments, TAM/SAM, opportunity matrix, and executive summary. Upgrade to unlock this feature."><MarketStudiesPage /></PageFeatureGate>}</Route>
      ...
      <Route path="/app/marketing/workflows">{() => <PageFeatureGate featureKey="marketingWorkflows" label="Marketing Workflows" description="Multi-step automation sequences with enrollment triggers, email sends, waits, and branches. Upgrade to unlock this feature."><WorkflowsPage /></PageFeatureGate>}</Route>
