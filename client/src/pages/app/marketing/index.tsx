...
export default function MarketingLandingPage() {
  ...
  const cards = [
    ...
    {
      title: "Campaigns",
      description: "Plan and manage multi-channel marketing campaigns.",
      icon: LayoutList,
      generated: false,
      loading: false,
      enterprise: true,
      ...
      testId: "card-campaigns",
    },
    {
      title: "Social Posts",
      description: "AI-generated social media content for your competitive positioning.",
      icon: Share2,
      generated: false,
      loading: false,
      enterprise: true,
      actionLabel: "View Social Posts",
      actionHref: "/app/marketing/social-posts",
