...
describe("calendar-rollup-core", () => {
  it("resolveBatchSource honors priority order", () => {
  ...
  it("collapses a dense batch on the same day with platform breakdown", () => {
  ...
  it("batch surfaces assignment ids only when consistent across members", () => {
  ...
  it("same source on different days splits, each carrying its own day", () => {
    const items: RollupSocialItem[] = [];
  ...
  it("small groups and standalone posts pass through untouched", () => {
    const items: RollupSocialItem[] = [
  ...
  it("same batch on different days does not merge", () => {
    const items: RollupSocialItem[] = [];
  ...
  it("unscheduled posts in a batch group together", () => {
    const items: RollupSocialItem[] = [];
