---
name: Synozur Website Codebase
description: Where the Synozur Insights website (www) code lives — Replit project name and GitHub repo.
---
...
**How to apply:** Any time a website MCP integration issue can't be explained from Orbit's side alone, check the Synozur-Baseline Replit or the GitHub repo for the MCP server implementation.
